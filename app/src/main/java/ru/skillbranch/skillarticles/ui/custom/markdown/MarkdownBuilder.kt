...
class MarkdownBuilder(context: Context) {
    ...
    private val linkDrawable = context.getDrawable(R.drawable.ic_link_black_24)!!.apply {
        // лучше задать tint 1 раз динамически, чем делать это каждый раз в replacement span
